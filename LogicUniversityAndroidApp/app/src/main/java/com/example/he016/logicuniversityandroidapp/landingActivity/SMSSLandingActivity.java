...
import com.example.he016.logicuniversityandroidapp.adjustmentVoucher.ListOfMonthlyAdjustmentActivity;
...
public class SMSSLandingActivity extends AppCompatActivity {


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_smsslanding);

        // use if statement to differentiate between SM SS
        if (JSONParser.userRole.equals("SM")) {
            final String[] options = {"View Adjustment Voucher", "Disbursement List",
                    "Retrieval List", "View Stock Card", "Purchase Order", "Approve/Reject Request"};

            ListView listView = (ListView) findViewById(R.id.listViewSMSSLanding);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> av, View v, int position, long id) {
                    ...
                    if (position == 0) {
                        //view adjustment
                        Intent i = new Intent(v.getContext(), ListOfMonthlyAdjustmentActivity.class);
