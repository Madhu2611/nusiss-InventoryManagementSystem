...
public class DRLandingActivity extends AppCompatActivity {
    ListView listView;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_drlanding);
        listView= (ListView)findViewById(R.id.listView1);
        String []values = {"Search Catalogue", "View Request", "Change of Collection Point"};
...
/*                if(position==2)
                ...
                if(position==2)
                {
                    Intent i= new Intent(v.getContext(),ChangeCollectionPointActivity.class);
